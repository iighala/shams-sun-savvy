    ...
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute top-20 right-20 w-80 h-80 rounded-full bg-secondary/15 blur-3xl"
        />
        <motion.div
      ...
      >
        <div className="bg-card rounded-3xl p-8 md:p-10 shadow-card border border-border/50 backdrop-blur-sm">
          ...
          <Link to="/" className="flex flex-col items-center mb-8">
            ...
            <p className="text-muted-foreground text-sm mt-1">Sign in to your SHAMS account</p>
          </Link>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full h-12 pl-11 pr-4 rounded-xl border ${errors.username ? "border-destructive" : "border-input"} bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring transition-all`}
                />
              </div>
