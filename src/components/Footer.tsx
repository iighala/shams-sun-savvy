      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <nav className="flex gap-6">
            {["Home", "About", "Features", "Calculator", "Contact"].map((l) => (
              <a key={l} href={`#${l.toLowerCase()}`} className="text-sm text-primary-foreground/70 hover:text-shams-gold transition-colors">
                {l}
              </a>
            ))}
          </nav>
